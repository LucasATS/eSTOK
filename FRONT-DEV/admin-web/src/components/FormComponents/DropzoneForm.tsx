    ...
    <>
      ...
      >
        <div
          ...
          className={`${
            isDragReject || error ? 'bg-red-50 border-error' : 'bg-gray-100 border-gray-300'
        ...
        >
          ...
          {isDragActive && !isDragReject && (
            <div className="flex flex-col justify-center items-center pt-5 pb-6">
              <svg
                ...
                className="mb-3 w-10 h-10 text-cancel"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
          ...
          {!isDragActive && (
            <div className="flex flex-col justify-center items-center pt-5 pb-6">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="mb-2 sm:mb-3 w-6 h-6 sm:w-10 sm:h-10 text-cancel"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
