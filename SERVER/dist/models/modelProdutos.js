...
var _modelCategorias = require("./modelCategorias");
var _modelTipo_Produtos = require("./modelTipo_Produtos");
var _modelUnidades = require("./modelUnidades");
...
var Produtos = _db["default"].define('produtos', {
  Nome: {
  ...
  id_categoria: {
    ...
    references: {
      model: _modelCategorias.Categorias,
      key: 'id'
    }
  },
  id_tp_produto: {
    type: _sequelize.DataTypes.INTEGER,
    references: {
      model: _modelTipo_Produtos.Tipo_Produtos,
      key: 'id'
    }
  },
  id_id_unidade: {
