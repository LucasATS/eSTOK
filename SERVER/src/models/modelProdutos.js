...
const Produtos = db.define('produtos', {
  ...
  id_tp_produto: {type: DataTypes.INTEGER, references: {model: Produtos, key: 'id'}},
  ...
  id_status: {type: DataTypes.INTEGER, references: {model: Produtos, key: 'id'}},
}, {});

Produtos.vw_produtos = async (id_satus) => {
