...
export const selectOptionsDestockingReason: SelectOption[] = [
  { id: 'destockingReason', value: 'destockingReason', label: 'Depreciado' },
  { id: 'destockingReason', value: 'destockingReason', label: 'Vencido' }
];
