...
var appConfig = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(server, PATH) {
    var urls;
        ...
        case 0:
          ...
          */
          ...
          server.listen(process.env.PORT, process.env.HOST, function () {
            return console.log("\n---\nSERVIDOR ON\nhttp://".concat(process.env.HOST, ":").concat(process.env.PORT, "/\n---"));
          });

          //INICIA ROTINAS
          (0, _rotinas.rotina_inativa_lotes)();
        case 10:
        case "end":
  ...
  return function appConfig(_x, _x2) {
